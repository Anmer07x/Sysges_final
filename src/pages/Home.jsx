...
import { FaFileAlt, FaFolderOpen, FaCalendarAlt, FaSignOutAlt } from "react-icons/fa";
import { useNavigate } from "react-router-dom";
import logo from "../assets/images/fondo.png"; // 

const DashboardEmpleado = ({ nombre = "anddfrea", diasDisponibles = 15 }) => {
  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="acciones-container">
        <div className="accion-card animate-card" onClick={() => navigate("/solicitar-permisos")}>
          <FaFileAlt className="icono" />
          <h3>Solicitar Permisos</h3>
          <p>Crear nueva solicitud de permiso o licencia</p>
        </div>

        <div className="accion-card animate-card" onClick={() => navigate("/ver-mis-permisos")}>
          <FaFolderOpen className="icono" />
          <h3>Ver Mis Permisos</h3>
          <p>Consulta el historial de tus solicitudes</p>
        </div>

        <div className="accion-card animate-card" onClick={() => navigate("/ver-calendario")}>
      ...
      <div className="solicitudes-card animate-card">
        ...
        <div className="solicitud-item">
          <div>
            ...
            <p className="solicitud-fecha">2025-10-25 - 2025-10-25 (1 día)</p>
          </div>
